        ...
        <form id="joinForm" autocomplete="off" method="post" novalidate="novalidate">
            ...
            <div class="join">
                ...
                <div class="inp_type_2 form-errors"><!-- focus / err -->
                    <input type="email" name="email" id="gcuseremail" placeholder="이메일 주소를 입력해주세요.">
                ...
                <div class="inp_type_2 form-errors form-password-rule">
                    <input type="password" name="password" placeholder="비밀번호를 입력해주세요." id="new_pw">
                    <label id="new_pw_msg" class="validate_msg_label"></label>
                </div>
    
                <b>비밀번호 확인</b>
                <div class="inp_type_2 form-errors">
                    <input type="password" placeholder="비밀번호를 입력해주세요." id="new_pw_re">
                    <label id="new_pw_re_msg" class="validate_msg_label"></label>
                </div>
    
                <b>닉네임</b>
                <div class="inp_type_2 form-errors btn-add">
                    <input type="text" id="unick" name="nickName" required="" class="required" placeholder="닉네임을 입력하세요." data-msg-required="닉네임을 입력하세요." data-rule-minlength="2" data-rule-maxlength="14" data-rule-spacechar="true" data-rule-specialchar="true"><label id="unick-error" class="error help-block default_label_txt icon-ic_downwards_arrow" for="unick"></label>
                </div>
