...
<script src="${cpath }/resources/js/main/function.js"></script>
		...
		<div id="content">
			<div class="main_spot">
			    ...
			    <div class="main_link">
			        <ul>
			            <li class="selected ml"><a href="#"><span class="ico_01"></span><p>모텔</p></a></li> 
			...
			<div class="recommend">	
			    ...
			    <ul>
			        <li>
			            <a href="#"><img src="https://image.goodchoice.kr/images/web_v3/b2b_banner.png"><strong>요기어때 비즈니스</strong>출장부터 복지까지<br>요기어때 비즈니스로 스마트하게</a>
			        </li>
			        <li>
			            <a href="#"><img src="https://image.goodchoice.kr/images/web_v3/re_jalnan.png"><strong>요기어때 서체 출시</strong>젊고 당당한 요기어때 잘난체<br>지금 다운로드 받으세요!</a>
			        </li>
			    </ul>
			</div>
